...
@Entity
@Table(name = "CH_PLZ")
public class Plz implements Serializable, Comparator<Plz>, Comparable<Plz> {
	...
	public int compareTo(Plz o) {
		...
		return (this.ortBez27).compareTo(o.getOrtBez27());
	}

	@Override
	public int compare(Plz o1, Plz o2) {

		return o1.getOrtBez27().compareTo(o2.getOrtBez27());
	}
