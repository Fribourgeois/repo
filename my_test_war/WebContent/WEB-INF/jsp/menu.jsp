...
<div id="menu">
    ...
    <br>
    <p><a href="<c:url value="/listPlz"/>">Numéros postaux en Suisse</a></p>
        
      <p><a href="<c:url value="/inscription"/>">Inscription</a></p>
     
      <p><a href="<c:url value="/loadPlz"/>">Charger les plz</a></p>
      
      <p><a href="<c:url value="/listBfs"/>">Afficher les bâtiments</a></p>
